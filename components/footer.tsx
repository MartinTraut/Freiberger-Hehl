...
import { company, images, services, navigation } from "@/lib/data";
    ...
    <footer className="bg-brand-dark text-white">
        ...
        <div className="grid gap-10 sm:gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mb-6 text-sm leading-relaxed text-brand-gray-400">
              ...
              und Baggerarbeiten in {company.region}.
            </p>
            <div className="flex gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 transition-colors hover:bg-brand-red hover:text-white"
                aria-label="Facebook"
              >
          ...
          {/* Leistungen */}
          <div>
            <h3 className="mb-6 font-display text-sm font-bold uppercase tracking-wider text-brand-gold">
              Leistungen
            </h3>
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-start gap-3 text-sm text-brand-gray-400 transition-colors hover:text-white"
                >
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 text-xs text-brand-gray-500 sm:flex-row">
